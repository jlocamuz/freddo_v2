...
def build_df(employee_ids, user_map, legajo_map, esquema_map):
    ...
    df["HORAS_TRABAJADAS"] = df["HORAS_REGULAR"].fillna(0) + df["HORAS_EXTRA"].fillna(0)
...
def main():
    ...
    # ✅ Totales 50/100: DESPUÉS del rename (para usar nombres lindos)
    ...
    # ✅ Orden final EXACTO (50 -> 50 noct -> 50 total, y 100 idem)
    cols_final = [
        "ID",
        "Apellido, Nombre",
        "Legajo",
